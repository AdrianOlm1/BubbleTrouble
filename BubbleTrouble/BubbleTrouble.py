...
# Sounds
mono_sound = pygame.mixer.Sound('sounds/shoot.wav')
tri_sound = pygame.mixer.Sound('sounds/pew.wav')
laser_sound = pygame.mixer.Sound('sounds/laser2.wav')
chain_sound = pygame.mixer.Sound('sounds/chain.wav')
circle_die = pygame.mixer.Sound('sounds/pop2.wav')
square_die = pygame.mixer.Sound('sounds/explode.wav')
gameover = pygame.mixer.Sound('sounds/gameover.wav')
gameoverBack = pygame.mixer.Sound('sounds/bass.wav')
levelUps = pygame.mixer.Sound('sounds/yipee.wav')
bomber = pygame.mixer.Sound('sounds/bomber.wav')
coinsound = pygame.mixer.Sound('sounds/kaching.wav')
